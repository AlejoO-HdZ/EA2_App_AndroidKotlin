...
2. MainActivity: Es la actividad principal de la aplicación. Permite:
...
3. Activity2: Es la segunda actividad. Su función principal es:

- Recibir el mensaje enviado desde MainActivity.
- Mostrar el mensaje recibido.
- Permitir seleccionar RECIBIDO (en color verde).
- Permitir seleccionar CANCELADO (en color rojo).
